...
# Gesture recognition options
    ...
    kinect_fake = "kinect20250531-190426-601.npz", # input to use when kinect disabled
    kinect_playback = False,
    kinect_record = False,
    kinect_file = "gest-data/finger-gesture/finger-gesture.k4a",
    kinect_color = False,       # also get color picture from kinect
    kinect_wide = False,        # wide FOV
    kinect_wide_unbinned = True,
    kinect_lo = 1,              # Select pixels that are between lo and hi
    kinect_hi = 1000,           #   millimeters from the Kinect sensor
    kinect_step = 10,
